...
#ifndef GLES2D_TILES__H
#define GLES2D_TILES__H
...
//    char        *ParallaxFilename;               // filename of the parallax .bmp
    ...
    int			MapGetXPosition( void ) { return XPosition[layer]; };
    int			MapGetYPosition( void ) { return YPosition[layer]; };
