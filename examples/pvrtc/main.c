...
GLES2D_Texture *GLES2D_CreateTextureFromPVR( char *filename );
...
//	rgba = GLES2D_CreateTexture( "../ressources/rgba.bmp", 0 );
	...
	background = GLES2D_CreateTextureFromPVR( "../ressources/test.pvr" );
...
//	background = GLES2D_CreateTexture( "../ressources/backg.bmp", 0 );
	...
	while(1)
	{
		...
		GLES2D_DrawTextureSimple( rgb565, 522, 0 );
/*
